...
export const ContactCards = () => {
  ...
  return (
    <div className="mt-10 p-4 bg-cyan-800 border border-gray-200 rounded-lg  sm:p-8 dark:border-gray-700 shadow-[-2px_-2px_20px_rgba(0,255,0,1),3px_3px_10px_rgba(0,0,0,0.2)] ">
